...
One page used **oasis** six times: the hero, the promise band, three service cards, and
the CTA. Any word repeated like that reads as machine-written, no matter how good the
word is. Use it once or not at all.

Same page, same problem: "tailored" five times, "guaranteed" as a refrain.
...
### 9. What FreshBooks does well — and what doesn't transfer
