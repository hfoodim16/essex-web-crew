---
name: ui-ux-pro-max
description: "UI/UX design intelligence: 67 styles, 161 palettes, 57 font pairings, 25 chart types across 22 stacks (React, Next.js, Vue, Svelte, Tailwind, shadcn/ui, SwiftUI, Flutter, and more). Use to plan, build, design, review, or improve UI — websites, landing pages, dashboards, SaaS, mobile/desktop apps — covering color, typography, spacing, layout, accessibility, animation, and components (buttons, modals, forms, tables, charts). Integrates shadcn/ui MCP."
---
