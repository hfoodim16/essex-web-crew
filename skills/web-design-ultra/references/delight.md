...
Find the one moment that earns personality, and protect the experience from whimsy that costs more than it gives.
...
Inspect the target, the direction chosen in Stage 5, the brand voice, repeated-use frequency, and emotional context. Look for:
