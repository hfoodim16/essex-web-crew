...
The mechanical quality floor: what to verify on the built result, and the category defaults to refuse. Load it once the direction is settled, immediately before editing UI.
