...
Decide *whether and why* to animate a moment. Pair with [motion.md](motion.md), which catalogs the specific entrance/hover/set-piece techniques once you know the job.
